...
const REPAIRS: Repair[] = [
  {
    ...
    imgs: {
      ...
      all: [
        `${baseUrl}arreglo-de-boton-rb-en-control-de-xbox-series-x-1.webp`,
        `${baseUrl}arreglo-de-boton-rb-en-control-de-xbox-series-x.webp`,
      ],
    },
    description:
  ...
  },
  {
    ...
    imgs: {
      ...
      all: [
        `${baseUrl}cambio-de-analogico-joystick-1.webp`,
        `${baseUrl}cambio-de-analogico-joystick.webp`,
      ],
    },
    description:
  ...
  },
  {
    ...
    imgs: {
      ...
      all: [
        `${baseUrl}cambio-de-modulo-para-este-xiaomi-redmi-mi-9t-1.webp`,
        `${baseUrl}cambio-de-modulo-para-este-xiaomi-redmi-mi-9t.webp`,
      ],
    },
    description:
  ...
  },
  {
    ...
    imgs: {
      ...
      all: [
        `${baseUrl}cambio-de-modulo-para-xiaomi-redmi-note-8-pro-1.webp`,
        `${baseUrl}cambio-de-modulo-para-xiaomi-redmi-note-8-pro.webp`,
      ],
    },
    description:
      'Reemplazo del módulo de carga defectuoso. Incluye pruebas de carga y verificación de puertos.',
  ...
  },
  {
    ...
    imgs: {
      ...
      all: [
        `${baseUrl}cambio-de-pin-de-carga-que-estaba-en-corto-y-se-revivio-la-bateria-para-este-joystic-de-ps4-1.webp`,
        `${baseUrl}cambio-de-pin-de-carga-que-estaba-en-corto-y-se-revivio-la-bateria-para-este-joystic-de-ps4.webp`,
      ],
    },
    description:
  ...
  },
  {
    ...
    imgs: {
      ...
      all: [
        `${baseUrl}cambio-de-tapa-trasera-de-iphone-8el-repuesto-ya-lo-tenia-el-cliente-1.webp`,
        `${baseUrl}cambio-de-tapa-trasera-de-iphone-8el-repuesto-ya-lo-tenia-el-cliente.webp`,
      ],
    },
    description:
  ...
  },
  {
    ...
    imgs: {
      ...
      all: [
        `${baseUrl}desbloqueo-de-arranques-en-netbook-del-gobierno-modelo-g5-1.webp`,
        `${baseUrl}desbloqueo-de-arranques-en-netbook-del-gobierno-modelo-g5.webp`,
      ],
    },
    description:
  ...
  },
  {
    ...
    imgs: {
      ...
      all: [
        `${baseUrl}mantenimiento-completo-para-ps3-super-slim-1.webp`,
        `${baseUrl}mantenimiento-completo-para-ps3-super-slim.webp`,
      ],
    },
    description:
